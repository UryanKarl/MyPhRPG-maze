...
// Modified: 2025.04.08 - Added event obstacle detection, improved pathfinding, and player obstacle switch
//=============================================================================

/*:
 * @plugindesc 智能寻路事件追逐 (增强版：避开事件障碍 + 允许绕路 + 玩家障碍开关)
 ...
 */
/*:ja
 * @plugindesc イベントもしくはプレイヤーに、高度な経路探索を提供します。（イベント障害物回避+迂回機能+プレイヤー障害スイッチ）
 * @author Shaz (modified by assistant)
 *
 * @param playerObstacleSwitchId
 * @text プレイヤー障害スイッチID
